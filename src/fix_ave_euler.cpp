  ...
  random_(0)
{
  ...
  array_flag = 1;
  size_array_rows = BIG; // each row is for a unique cell
  size_array_cols = 3 + 1 + 3 + 1 + 6 + 1; // FEG - cell pos (x,y,z), volume fraction in cell, average velocity in cell, pressure, stress tensor (xx, yy, zz, xy, yz, xz), average radius;
