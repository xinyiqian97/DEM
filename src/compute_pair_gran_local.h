...
class ComputePairGranLocal : public Compute {
 ...
 public:
  ...
  { return (overlapRatioflag > 0 ? posflag*6+velflag*6+idflag*3+fflag*3+fnflag*3+ftflag*3+torqueflag*3+torquenflag*3+torquetflag*3+histflag*dnum+areaflag*1 + deltaflag*1 + heatflag*1: -1);} // FEG
  
    virtual int offset_squaredforce() // FEG
  { return (squaredforceflag > 0 ? posflag*6+velflag*6+idflag*3+fflag*3+fnflag*3+ftflag*3+torqueflag*3+torquenflag*3+torquetflag*3+histflag*dnum+areaflag*1 + deltaflag*1 + heatflag*1 + overlapRatioflag*1: -1);} // FEG
  
  virtual int offset_contact_point()
  {
    return (cpflag > 0 ?   posflag*6+velflag*6+idflag*3+fflag*3+fnflag*3+ftflag*3+torqueflag*3+torquenflag*3+torquetflag*3+histflag*dnum+areaflag*1 + deltaflag*1 + heatflag*1 + overlapRatioflag*1 + squaredforceflag*1 : -1); // FEG - added in overlapRatioflag and squaredforceflag, I'm putting cpflag at the end to be consistent with post-processing scripts
 ...
 protected:
  ...
  int posflag,velflag,idflag,fflag,fnflag,ftflag,torqueflag,torquenflag,torquetflag,histflag,areaflag,deltaflag,heatflag,overlapRatioflag,squaredforceflag,cpflag; // FEG - added overlapRatioflag, squaredforceflag
