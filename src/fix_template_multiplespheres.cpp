  ...
  scale_fact(1.0)
{
  ...
  if(nspheres < 1) error->fix_error(FLERR,this,"illegal number of spheres"); //FEG - I'm just trying to allow single-pebble clumps and take advantage of multisphere attributes.
